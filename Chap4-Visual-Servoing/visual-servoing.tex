...
\begin{figure*}[ht]
 \centering
 \subfigure{\includegraphics[scale=.23]{Chap4-Visual-Servoing/velocities_both}}
 \subfigure{\includegraphics[scale=.23]{Chap4-Visual-Servoing/errors_both}}
